...
#exam[
  ...
  $
  Нетрудно проверить, что все они индуцируют одну и ту же топологию. Кроме того, всякое $n$-мерное пространство над $RR$ естественно изоморфно $RR^n$. Мы докажем, что естественная топология на $RR^n$ --- это единственная вукторная топология, возможная в произвольном вещественном $n$-мерном ТВП.
]
