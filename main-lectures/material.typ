...
#th[
  ...
  // + множество $E subset X$ ограничено $<==>$ все полунормы $p in cal(P)$ ограничены на $E$.
] <seminorm-to-base>
#pf[
  ...
  Также заметим, что по @seminorm-prop[лемме] каждое множество $U in cal(B)$ выпукло, уравновешено и поглощающе, и $cal(B)$ является локальной базой топологии $tau$ в нуле.\
...
= Полнота и теорема Банаха-Штейнгауза
...
#pf[
  ...
  Однако $E$ замкнуто, как перечечение замкнутых множеств, поэтому
  $
